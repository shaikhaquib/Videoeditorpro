package com.dis.proeditor.ActivityVideoCollage.CollageUtils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < CollageUtils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.dis.proeditor.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width = collageSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.dis.proeditor.ActivityVideoCollage.CollageBitmapUtils.CollageUtils.width, imageHeight, true);
