package com.dis.proeditor.ActivityMain;
...
import com.dis.proeditor.ActivityVideoList.ActivityVideoList;
import com.dis.proeditor.ActivityVideoMusicList.ActivityVideoMusicList;
...
public class ActivityMain extends AppCompatActivity {
 ...
 builder.forUnifiedNativeAd(new UnifiedNativeAd.OnUnifiedNativeAdLoadedListener() {
    ...
    public void videojoin(View view) {
        ...
        final Intent intent = new Intent(this, com.dis.proeditor.ActivityVideoJoiner.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
    ...
    public void videotoimg(View view) {
        ...
        final Intent intent = new Intent(this, com.dis.proeditor.ActivityVideoGIF.ActivityVideoList.class);
        intent.setFlags(67108864);
        if (mInterstitialAd != null && mInterstitialAd.isLoaded()) {
            mInterstitialAd.show();
            mInterstitialAd.setAdListener(new AdListener() {
